...
const Registration = () => {
    ...
    const bgImgStyle = {backgroundImage: "url(/food3.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center center", width: "100vw", height: "100vh", position: "absolute", left: 0, top: 0 };
